      ...
      <div className="">
        ...
        <section className="bg-[#0e0e0e] relative">
          ...
          <div className="container px-5 py-24 mx-auto flex">
            <div className="lg:w-[26%] max-[768px]:invisible max-[425px]:invisible bg-[#ffffffeb] rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
              <div>
          ...
          <div className="lg:invisible max-[425px]:visible bg-[#ffffffeb] rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
